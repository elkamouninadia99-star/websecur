...
export default function Navbar() {
  ...
  return <header className="fixed inset-x-0 top-0 z-50 px-4 pt-3"><nav className="surface mx-auto flex h-13 max-w-6xl items-center justify-between rounded-2xl px-4 sm:px-5">
