...
export default function FeatureCard({
  ...
  return (
    <motion.div
      ...
      className="group relative overflow-hidden rounded-3xl border border-cyan-500/10 bg-white/[0.04] p-7 backdrop-blur-xl transition-all duration-300 hover:border-cyan-400/30"
    >
      {/* Glow */}
